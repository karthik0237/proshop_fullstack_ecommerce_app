...
import { addToCart, CART_REMOVE_ITEM } from "../redux/slice/cartSlice";
                  ...
                  <Row>
                    ...
                    <Col>
                      <Button
                        ...
                        variant="light"
                        onClick={(e) => {
                          dispatch(CART_REMOVE_ITEM(item.product));
      ...
      <Col md={4}>
        <Card>
          <ListGroup variant="flush">
            <ListGroupItem>
              <h4>
                Sub total ({cartItems.reduce((acc, item) => acc + Number(item.qty), 0)})
                items{" "}
              </h4>
              <p>
